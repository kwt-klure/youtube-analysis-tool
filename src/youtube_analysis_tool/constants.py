...
DEFAULT_BURNED_SUBTITLE_SAMPLE_FPS = 4.0
DEFAULT_BURNED_SUBTITLE_PROBE_DURATION_SECONDS = 120.0
DEFAULT_BURNED_SUBTITLE_PROBE_SAMPLES = 12
DEFAULT_BURNED_SUBTITLE_PROBE_MIN_HITS = 4
DEFAULT_BURNED_SUBTITLE_PROBE_MIN_DISTINCT_TEXTS = 3
DEFAULT_BURNED_SUBTITLE_BAND_HEIGHT_RATIO = 0.22
DEFAULT_BURNED_SUBTITLE_SIDE_MARGIN_RATIO = 0.04
DEFAULT_BURNED_SUBTITLE_DIFF_THRESHOLD = 0.02
DEFAULT_BURNED_SUBTITLE_EARLY_GATE_SECONDS = 180.0
DEFAULT_BURNED_SUBTITLE_EARLY_GATE_EVENTS = 40
DEFAULT_BURNED_SUBTITLE_MIN_NONEMPTY_HITS = 8
DEFAULT_BURNED_SUBTITLE_MIN_HIT_RATE = 0.35
DEFAULT_BURNED_SUBTITLE_MIN_CJK_CHARS = 120
DEFAULT_BURNED_SUBTITLE_MIN_EFFECTIVE_CJK_CHARS = 2
BURNED_SUBTITLE_TESSERACT_LANGS = ("chi_tra", "chi_sim", "jpn", "kor")
